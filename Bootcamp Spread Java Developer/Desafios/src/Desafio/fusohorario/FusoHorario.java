...
public class FusoHorario {
    ...
    public static void main(String[] args) {
        ...
        int saidaviagem = horasaida + tempoviagem;

        if (saidaviagem >= 24){
            saidaviagem = saidaviagem - 24;
        } else if (horasaida == 0 || saidaviagem <= 0){
            saidaviagem = saidaviagem + 24;
        };

        int ajuste = saidaviagem + fuso;
